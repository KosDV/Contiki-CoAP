/* PC_CLIENT RECEIVES DATA FROM SENSOR */
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
#include "contiki.h"
...
char* service_urls[NUMBER_OF_URLS] = {"printer", ".well-known/core", "value"};
/********************************************************************/
static void
send_data(void)
{
	printf("Entering in send_data \n");
...
/********************************************************************/
/********************************************************************/
PROCESS(coap_client, "Starting client...");
